 ...
 */
     ...
     */
         ...
         * @param \App\Enums\EnumApiResponseFormat $response_format
         * @static
         */
        public static function jsonIcalResponse($events, $response_format = \App\Enums\EnumApiResponseFormat::JSON)
        {
                        return \Illuminate\Routing\ResponseFactory::jsonIcalResponse($events, $response_format);
        }
